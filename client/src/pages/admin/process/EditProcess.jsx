...
const EditDomain = () => {
  ...
  return (
    <Section>
      <SectionTitle title="Edit Proses"></SectionTitle>
      <Box>
        <div className="mb-8">
          <div className="flex">
            ...
            <div className="grid grid-cols-12 gap-4">
              <div className="col-span-12 md:col-span-6 flex flex-col gap-1">
                ...
                <Select ref={domainRef}>
                  <option value="">{dataProcess.domain.kode}</option>
                </Select>
              </div>
              <div className="col-span-12 md:col-span-6 flex flex-col gap-1">
                <Label label="Kode" />
