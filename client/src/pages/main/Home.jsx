...
const Home = () => {
  return (
    <section className="relative min-h-screen">
      <div className="max-w-screen-xl mx-auto px-4">
        <div className="flex flex-col lg:flex-row gap-2 md:gap-5">
          <div className="flex flex-col justify-center lg:justify-start w-full pt-20 text-center lg:text-left md:max-w-full">
            <h1 className="text-gray-700 text-4xl md:text-5xl lg:text-6xl font-bold capitalize">
              Berikan Penilaian Anda Terhadap{" "}
              <span className="text-primary">Sistem Kami</span>
            </h1>
            <p className="text-lg text-gray-700 mt-4">
              Penilaian Anda sangat berharga bagi kami dalam upaya meningkatkan
              sistem penjualan kami.
            </p>
            <div className="mt-4">
          ...
          <div className="w-full pt-8 md:pt-16 flex items-center justify-center lg:justify-start">
            ...
            >
              <path
                id="uuid-fb20b2b5-bc5b-4117-a1ee-c5d1a8aa62bd-283"
              ...
              />
              <path
                id="uuid-e639489a-d12b-4c23-97cb-2af79ea40b7d-284"
              ...
              />
              <path
                id="uuid-56df27a3-bbb6-4bd2-b7f5-888148e3fe66-285"
              ...
              />
              <path
                id="uuid-e3777ca2-fb97-40f5-b301-a7df89d05aed-286"
      ...
      <div className="absolute z-1/2 top-1/2 right-0 -z-10 rounded-full h-[300px] w-[300px] bg-gradient-to-r -translate-y-1/2 -translate-x-1/2 from-cyan-500 to-blue-500 blur-[100px]"></div>
    </section>
  );
};
